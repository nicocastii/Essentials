...
//Name: Challenge1.ma
//Last modified: Sun, Aug 30, 2026 11:29:20 PM
//Codeset: 1252
requires maya "2027";
...
fileInfo "UUID" "C3422325-4A32-FE51-FA01-46B369007274";
createNode transform -s -n "persp";
	rename -uid "0B7C4C57-43F3-7A48-CB4E-46ADFDF31E10";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 5.808580153665293 15.184551457504538 22.058999220197116 ;
	setAttr ".r" -type "double3" -29.399999999999181 376.39999999996928 -1.6577235221596406e-15 ;
	setAttr ".rpt" -type "double3" 1.2044878029188853e-15 2.5662286490544194e-15 -1.7045950976629004e-15 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "B1ED37FF-4D21-D09C-3AF5-97AFF477AAEB";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999979;
	setAttr ".coi" 26.677515932169609;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" -0.75354925698512365 2.0884587492744062 -0.23720381275367686 ;
...
createNode transform -n "Floor";
	...
	setAttr ".s" -type "double3" 8.2412319291314819 8.2412319291314819 8.2412319291314819 ;
...
createNode transform -n "Tabletop";
	...
	setAttr ".s" -type "double3" 3.9728167356898214 0.29796125517673633 2.4830104598061356 ;
...
createNode transform -n "ChairSeat";
	...
	setAttr ".s" -type "double3" 2 0.4 2 ;
...
createNode transform -n "ChairBack";
	...
	setAttr ".s" -type "double3" 2 2.5 0.3 ;
...
createNode transform -n "pCube1";
	...
	setAttr ".s" -type "double3" 3.15 0.3 0.3 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "49A91629-4C72-ED48-3E9D-02AB6A3A56C7";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "6B77F159-45FE-9105-F81E-E7A05BF6C4D5";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "D0132CBC-4559-73F9-45F5-CA9895556DC1";
createNode displayLayerManager -n "layerManager";
	rename -uid "EE74B4CF-4E64-6C9F-543E-B4955136F4D6";
createNode displayLayer -n "defaultLayer";
	rename -uid "36D4D2ED-4676-0783-732F-9C918AA3D2B3";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "F3EC8F47-4811-65F6-E887-41BE84A530A2";
...
connectAttr "polyCube5.out" "ChairBackShape.i";
